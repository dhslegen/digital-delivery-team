...
const KNOWN_POSITIONAL    = new Set(['prd','wbs','design','design-brief','design-execute','build-web','build-api','integrate','test','review','package','report','fix']);
...
function scanCommands() {
  ...
  const posOrder = ['prd','wbs','design','design-brief','design-execute','build-web','build-api','integrate','test','review','fix','package','report'];
